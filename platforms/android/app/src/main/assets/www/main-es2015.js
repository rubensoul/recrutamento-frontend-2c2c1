...
const routes = [
    ...
    {
        path: 'clan',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-clan-clan-clan-module */ "pages-clan-clan-clan-module").then(__webpack_require__.bind(null, /*! ./pages/clan/clan/clan.module */ "./src/app/pages/clan/clan/clan.module.ts")).then(m => m.ClanPageModule),
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'details',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-clan-details-details-module */ "pages-clan-details-details-module").then(__webpack_require__.bind(null, /*! ./pages/clan/details/details.module */ "./src/app/pages/clan/details/details.module.ts")).then(m => m.DetailsPageModule),
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
];
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            this.authService.setToken(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].token);
        });
    }
};
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_9__["NativeStorage"],
            {
                ...
                useClass: _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__["TokenInterceptor"],
                multi: true
            },
        ],
...
/***/ "./src/app/shared/auth/alert.service.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/auth/alert.service.ts ***!
  \**********************************************/
...
/* harmony import */ var _alert_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./alert.service */ "./src/app/shared/auth/alert.service.ts");
...
let TokenInterceptor = class TokenInterceptor {
    ...
    intercept(request, next) {
        ...
        if (this.token == null) {
            this.token = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].token;
        }
...
const environment = {
    production: false,
    api: 'https://api.royaleapi.com/clan/',
...
module.exports = __webpack_require__(/*! /Users/rubensoul/Documents/teste_empresas/recrutamento-frontend-2c2c1/src/main.ts */"./src/main.ts");
